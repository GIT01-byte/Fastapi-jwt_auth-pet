...
Это высокопроизводительный API-сервис аутентификации на базе FastAPI, использующий JWT (RS256) для управления сессиями. Проект реализует полноценный цикл: регистрацию, вход, обновление токенов и механизм инвалидации сессий (Blacklist в Redis).
